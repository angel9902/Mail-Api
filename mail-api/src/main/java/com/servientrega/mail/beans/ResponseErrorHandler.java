...
import com.servientrega.mail.dto.Error;
...
public class ResponseErrorHandler {
    ...
    @Handler
    public MailResponse handler(Exchange exchange) {
        ...
        if (exception instanceof BeanValidationException) {
            ...
            mailResponse.addError(error);
        }
        mailResponse.setSuccess(Boolean.FALSE);
        return mailResponse;
    }
}
